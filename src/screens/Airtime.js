...
import LocalAirtime from './LocalAirtime';
import InterAirtime from './InternationalAirtime';
  ...
  return (
    <View style={styles.container1} {...panResponder.panHandlers}>
      ...
      {loading ? (
        ...
        <>
          {displayText === 'local' && <LocalAirtime />}
          {displayText === 'international' && <InterAirtime />}
        </>
      )}
    </View>
  );
